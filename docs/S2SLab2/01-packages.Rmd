...
The textbook these labs are based on <!-- link to Ugarte --> uses the `PASWR2` package throughout. To install this package, run the following code.
...
For more information on installing and loading packages, see [Section 1.8 Packages](https://read.kortext.com/reader/pdf/92741/19) in *Probability and Statistics with R*.
