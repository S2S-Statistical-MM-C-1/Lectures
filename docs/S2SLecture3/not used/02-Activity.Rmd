...
In order to estimate the average number of drinks it takes these 146 university students to get drunk:
...
**Step 3. Calculate your sample mean, sample standard deviation and estimate of the standard error**
...
**Step 4. Submit your point estimate of the population mean via Google Form**
