...
hist(sample.mean)
hist(sample.mean[sample.mean<10], main="sample.mean (tidied)")

hist(sample.standard.deviation)
hist(sample.standard.deviation[sample.standard.deviation<10],main="sample.standard.deviation (tidied)")
