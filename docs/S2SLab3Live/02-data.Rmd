...
## Checking variable types {#checking}

Once a data frame has been read into R, it is always a good idea to examine its contents using the `str()` function to see the **structure** of the data object. We have already seen the `str()` function in [Lab 2](https://s2s-statistical-mm-c-1.github.io/Labs/S2SLab2Live/docs/data.html#df) but as a reminder, it shows us the type of vector each column in a data frame is saved as.
...
We can use what we learned in [Lab 2](https://s2s-statistical-mm-c-1.github.io/Labs/S2SLab2Live/docs/data.html#fact) to change these variables into factors. 
